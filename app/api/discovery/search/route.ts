...
export async function POST(request: Request) {
  try {
    ...
    return Response.json(await discoverSources(env.DB, input.query ?? "", {
      limitPerProvider: input.limitPerProvider,
      crawlTop: input.crawlTop,
      bingApiKey: env.BING_WEB_SEARCH_API_KEY,
